...
<div id="main">
    ...
    <form class="form-horizontal" role="form" action="setType" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input type="text" class="form-control" name="courseSet[0].teacher.id" placeholder="请输入讲师编号">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label">讲师姓名</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" name="courseSet[0].teacher.name" placeholder="请输入讲师姓名">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label">讲师编号</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" name="courseSet[1].teacher.id" placeholder="请输入讲师编号">
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label">讲师姓名</label>
            <div class="col-sm-3">
                <input type="text" class="form-control" name="courseSet[1].teacher.name" placeholder="请输入讲师姓名">
            </div>
        </div>
        <div class="form-group">
